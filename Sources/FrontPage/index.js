Vue.component('page-header', {
  ...
  template: `
  <header class="w-full bg-transparent fixed top-0 left-0 z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-6" id="navbar">
    ...
    <div class="">
      <a href='/fair-rate-mortgage/'>
        <svg xmlns="http://www.w3.org/2000/svg" width="188" height="39"><text transform="translate(87 29)"
            ...
            <tspan x="0" y="0">ReviewBĐS.vn</tspan>
          </text>
...
Vue.component('page-banner', {
  ...
  template: `
  <section
  class="relative bg-blue-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-32 pb-48 sm:pb-64 md:pt-40 md:pb-48 lg:pt-40 xl:pb-64 2xl:pt-56 2xl:pb-96 text-center sm:text-left">
  <div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g transform="translate(1950.456 5248.5)">
          ...
          <path d="M.862,0,6.536,11.517l-.018,2.488L0,.358.862,0" transform="translate(-920.894 -4919.823)"
            fill="#2e3e5c" />
          <path d="M.818,0l9.544,8.558.783,2.192L0,.6.818,0" transform="translate(-938.117 -4888.993)"
            fill="#2e3e5c" />
          ...
          <g transform="translate(-1109.5 -5110.5)">
            ...
            <g transform="translate(17 19)">
              <path d="M10,0,0,12H20L10,0" transform="translate(8)" fill="#b6eceb" /><text
                transform="translate(18 28)" fill="#454f5b" font-size="17.28"
          ...
          <g transform="translate(-1322.5 -5124.5)">
            ...
            <g transform="translate(19 21)">
              <path d="M11,0,0,13H22L11,0" transform="translate(9)" fill="#007ace" /><text
                transform="translate(20 31)" fill="#454f5b" font-size="19.2"
                font-family="ArialRoundedMTBold, Arial Rounded MT">
